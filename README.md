...
--------------------------------------------------------------------
local Library = Update:Window("GG HUB ","")
------------------------------------------
...
Setting:Label("⚡ENTRE NO MEU DISCORD GG COMUNNITY!!⚡")
...
Main:Seperator("  @GGSCRIPTS NO YOUTUBE 🇧🇷")
...
Main:Seperator(" Ilha Da Miragem 🏝️ | GG SCRIPTS |")
...
wait(1)
Notification:Notify(
   {Title = "GG HUB", Description = "You Have Max Observation"},
...
Weapon:Seperator(" Missões📜 | GG SCRIPTS |")
...
spawn(function()
 ...
 DevilFruit:Seperator(" outros | GG scripts |  ")
